  ...
  { repeat straightline.
    ...
    { repeat letexists. split; [repeat straightline|].
      ...
      { subst v1. subst x7.
        ...
        rewrite Z.mod_small; cycle 1. { clear -HH H4. PreOmega.zify. Z.div_mod_to_equations. Lia.lia. }
        rewrite length_skipn.
        rewrite Z.div_mul by discriminate.
        (* Z and nat ... *)
        PreOmega.zify; rewrite Z2Nat.id in *; Z.div_mod_to_equations; Lia.lia. }
