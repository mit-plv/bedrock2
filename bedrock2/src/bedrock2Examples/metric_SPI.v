...
Section WithParameters.
  ...
  Proof.
    ...
    refine ((atleastonce ["b"; "busy"; "i"] (fun v T M B BUSY I MC =>
    ...
    { eexists; eexists; split; repeat straightline.
      2: {
        (* TODO why do i need to do all this manually now *)
        repeat split; eauto.
        exists []; split; eauto.
        exists []; repeat split; eauto.
        - unfold mmio_trace_abstraction_relation; eauto.
        - apply kleene_empty.
    ...
    *)
    ...
    (* fails to generate any cases now *)
    admit.
