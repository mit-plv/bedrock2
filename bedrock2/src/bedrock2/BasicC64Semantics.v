...
#[global] Instance mapok: coqutil.Map.Interface.map.ok mem := SortedListWord.ok Naive.word64 _.
#[global] Instance wordok: coqutil.Word.Interface.word.ok word := Naive.word64_ok.
