...
Section WithMem.
  ...
  Definition leakage_ext_spec{mmio_ext_calls: MemoryMappedExtCalls}: ExtSpec :=
  ...
  Lemma weaken_leakage_ext_spec{mmio_ext_calls: MemoryMappedExtCalls}
  ...
  Instance leakage_ext_spec_ok(mmio_ext_calls: MemoryMappedExtCalls)
    {mmio_ext_calls_ok: MemoryMappedExtCallsOk mmio_ext_calls}: ext_spec.ok leakage_ext_spec.
  Proof.
    constructor.
    - (* mGive unique *)
    ...
    - (* weaken *)
      unfold Morphisms.Proper, Morphisms.respectful, Morphisms.pointwise_relation,
        Basics.impl. eapply weaken_leakage_ext_spec.
    - (* intersect *)
      unfold leakage_ext_spec. intros. fwd. destruct Hp1; destruct H0p1; fwd;
        match goal with
  ...
  Definition ext_spec_ok(mmio_ext_calls: MemoryMappedExtCalls)
    {mmio_ext_calls_ok: MemoryMappedExtCallsOk mmio_ext_calls}: Semantics.ext_spec.ok ext_spec := deleakaged_ext_spec_ok.
End WithMem.

#[export] Existing Instance leakage_ext_spec.
#[export] Existing Instance leakage_ext_spec_ok.
