...
Goal False.
  ...
  assert (map.union (map.put (map.put map.empty "z" 7) "0" 0) (map.put (map.put (map.put map.empty "a" 6) "z" 0) "c" 9) = (map.put (map.put (map.put (map.put map.empty "a" 6) "z" 0) "c" 9) "0" 0)) by exact eq_refl.
Abort.