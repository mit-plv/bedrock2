...
Section WeakestPrecondition.
  ...
  Proof.
    ...
    { destruct H1 as (?&?&?). eexists. split.
      { eapply Proper_expr.
        ...
        { eauto. } }
      { intuition eauto 6. } }
    { eapply H2; try solve [typeclasses eauto with core]. eassumption. }
    { destruct H1 as (?&?&?&?&?&HH).
      eassumption || eexists.
      eassumption || eexists.
      eassumption || eexists.
  ...
  Proof.
    ...
    { admit. } (* This case is not actually true because of the additional metrics.. will need to strengthen the weakest predcondition when it comes to it *)
