...
Notation stmt := (stmt var func Empty_set).
...
Definition eval_stmt_test fuel initialSt := @eval_stmt (word 32) _ _ _ _ _ (List_Map _ _) empty_map fuel initialSt no_mem.
