(*Here we have maximum generality: dependent types and arbitrary equivalence relations*)
...
(*Here we have dependent types but equivalence relations are eq.
  Cannot simply deduce these lemmas from supposedly-general case,
...
Goal type_of_Fix_eq'_eq -> type_of_Fix_eq.
  cbv [type_of_Fix_eq type_of_Fix_eq'_eq]. auto. Qed.
