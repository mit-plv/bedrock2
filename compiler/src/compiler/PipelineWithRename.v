...
Unable to unify "?Goal8@{t2:=t; m2:=r0; t:=t; r0:=r0}" with
 "?Goal7@{t2:=t; m2:=r0; t:=t; r0:=r0}".

even though it's behind a "try" *)

        eauto 10.
      + move Hll at bottom.
        unfold FlattenExprSimulation.related in *. exact Hll. eassumption.
...
, loopBodyGhostConsts, FlatToRiscvFunctions.goodMachine in *.
