...
Section FlattenExpr1.
  ...
  Fixpoint flattenExpr(ngs: NGstate)(resVar: option String.string)(e: Syntax.expr):
    (FlatImp.stmt String.string word * String.string * NGstate) :=
    match e with
  ...
  Definition flattenExprAsBoolExpr(ngs: NGstate)(e: Syntax.expr):
    (FlatImp.stmt string word * FlatImp.bcond string * NGstate) :=
  ...
  Fixpoint flattenExprs(ngs1: NGstate)(es: list Syntax.expr):
    (FlatImp.stmt string word * list String.string * NGstate) :=
    match es with
  ...
  Fixpoint flattenStmt(ngs: NGstate)(s: Syntax.cmd): (FlatImp.stmt string word * NGstate) :=
    match s with
  ...
  Definition ExprImp2FlatImp(s: Syntax.cmd): FlatImp.stmt string word :=
  ...
  Definition flatten_function: list string * list string * Syntax.cmd ->
                               result (list string * list string * FlatImp.stmt string word) :=
